/**
 * FAQ & Knowledge Base Nodes
 * 
 * Educational content about twin3 platform, tokenomics, and features
 */

import type { InteractionNode } from './types';

export const faqNodes: InteractionNode[] = [
  // ============================================================
  ...
  // ============================================================
  {
    ...
    suggestedActions: [
      { label: 'Learn about Twin Matrix', payload: 'faq-03' },
      { label: 'How to earn?', payload: 'air-04' },
  ...
  },
  {
    ...
    suggestedActions: [
      { label: 'What is twin3?', payload: 'faq-01' },
      { label: 'View roadmap', payload: 'faq-13' },
  ...
  // ============================================================
  {
    ...
    suggestedActions: [
      { label: 'Why is this valuable?', payload: 'faq-04' },
      { label: 'View my matrix', payload: 'matrix' },
      { label: 'Start building', payload: 'verify_human' }
    ]
  },
  {
    id: 'faq-04',
    ...
    suggestedActions: [
      { label: 'How do I earn?', payload: 'air-04' },
      { label: 'Privacy protection', payload: 'air-10' },
      { label: 'Start earning', payload: 'verify_human' }
    ]
  },
  {
    id: 'faq-06',
