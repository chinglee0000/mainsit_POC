/**
 * WelcomeMember View - UI Layer (GREEN ZONE)
 * 
 * Pure UI rendering for welcome member modal.
 */

import React from 'react';
import { Sparkles, Trophy, X, PartyPopper } from 'lucide-react';
import { formatNumber, getOrdinalSuffix } from './index';

// ─── Types ──────────────────────────────────────────────
export interface WelcomeMemberViewProps {
  memberNumber: number;
  isVisible: boolean;
...
// ─── Component ──────────────────────────────────────────
export const WelcomeMemberView: React.FC<WelcomeMemberViewProps> = ({
  memberNumber,
  isVisible,
  showConfetti,
  onClose,
