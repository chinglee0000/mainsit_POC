/**
 * WalletBinding View - UI Layer (GREEN ZONE)
 * 
 * Pure UI rendering for wallet binding widget.
 * Displays different steps: choose, connecting, conflict, success
 */
...
import type { BindingStep, BindingType } from './index';

// ─── Types ─────────────────────────────────────────────────
export interface WalletBindingViewProps {
  step: BindingStep;
...
// ─── Component ─────────────────────────────────────────────
export const WalletBindingView: React.FC<WalletBindingViewProps> = ({
  step,
  bindingType,
  progress,
  walletAddress,
          ...
          <div>
            ...
            >
              <div style={{
                ...
                <BrandIcon brand="metamask" size={24} />
              </div>
          ...
          <div style={{ padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            >
              <div style={{
                ...
                <BrandIcon brand="metamask" size={32} />
              </div>
              <div style={{ flex: 1 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {bindingType === 'self-custody'
                ? <BrandIcon brand="metamask" size={40} />
                : <BrandIcon brand="telegram" size={40} />
              }
            </div>
          </div>
      ...
      <div className="card animate-fade-in" style={cardStyle}>
        <div style={{
          ...
          <p style={{
            ...
            This wallet (<span style={{ fontFamily: 'monospace', fontSize: '12px' }}>{mockData.conflictAddress}</span>) is already linked to another account.
          </p>
        </div>
